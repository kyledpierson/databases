...
%>
	...
	Report a book as lost:<BR><BR>
	<form name="lose" method=get action="lose.jsp">
		<input type=hidden name="searchAttribute" value="lose">
		<table id="no_border">
...
%>  
  ...
  <p><b>Lost results:</b><BR><BR>

  <%=order.lost(user, book, connector)%><BR><BR>
